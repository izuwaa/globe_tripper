...
agent_instructions_path = os.path.join(os.path.dirname(__file__), '../artifacts/bureaucracy/instruction.md')
...
_agent_config = agent_configs.get('bureaucracy', {})


# The BureaucracyAgent (intake agent)
